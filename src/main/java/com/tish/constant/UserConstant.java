...
public class UserConstant {
	...
	public static final String READ_USER_RESULTS = "select ur.id, ur.user_id, m.title, t.question, ur.answer, ur.result from users_results ur inner join tests t on t.id = ur.question_id inner join materials m on m.id = t.material_id where ur.user_id = ?";
